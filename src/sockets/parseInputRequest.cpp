...
const std::string& ParseInputRequest::getType() const {
    return type;
}

const std::string& ParseInputRequest::getUrl() const {
    return url;
}

const std::string& ParseInputRequest::getDns() const {
    return dns;
}

const std::string& ParseInputRequest::getHeader() const {
    return header;
}

const std::string& ParseInputRequest::getBody() const {
    return body;
}

const std::string& ParseInputRequest::getContent() const {
    return content;
}
...
void ParseInputRequest::parse(const std::string& rawInput) {
    ...
    // 2. EXTRAER Y PROCESAR LAS CABECERAS (Headers) 
        ...
        while (pos < totalLen) {
            ...
            if (colon != std::string::npos) {
                ...
                if (lowerKey == "host") {
                    ...
                    type = val;
                } else if (lowerKey == "authorization" || lowerKey == "x-security-token") {
                    securitiHeader = val;
                }
            }
        }
...
bool Server::is_request_complete(const std::string& rawInput) {
